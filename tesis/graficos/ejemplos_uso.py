...
def generar_flujo_ingresos():
    grafico_lineas_multiples(
        ...
        series=[
            {
                "nombre": "Ingresos",
                "y": [451600, 555600, 670160, 780160, 782540, 1143620, 1183000, 1199380, 1526180, 1571560],
            },
            {
                "nombre": "Costos",
                "y": [390800, 445300, 507405, 566571, 564536, 771977, 787713, 793864, 982410, 1003454],
            },
            {
                "nombre": "Flujo neto",
                "y": [60800, 110300, 162755, 213589, 218004, 371643, 395287, 405516, 543770, 568106],
            },
        ],
