...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{7.1cm} c}
		...
		\hline
	\end{tabular}
	\caption{Supuestos económicos y financieros adoptados para la evaluación de MuseIQ. Fuente: elaboración propia con base en `MuseIQ.pdf` y en el Capítulo 5.}
...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{8.3cm} c}
		...
		\hline
	\end{tabular}
	\caption{Composición de la inversión inicial de MuseIQ. Fuente: elaboración propia con base en `MuseIQ.pdf`.}
...
\begin{figure}[h!]
	...
	\caption{Composición porcentual de la inversión inicial de MuseIQ. Fuente: elaboración propia con base en la Tabla~\ref{tab:inversion-inicial}.}
...
\begin{table}[h!]
	...
	\begin{tabular}{c c c c c c c}
		...
		\hline
	\end{tabular}
	\caption{Flujo económico anual de MuseIQ en el escenario base. Montos en USD. Fuente: elaboración propia.}
...
\begin{figure}[h!]
	...
	\caption{Comparación entre ingresos, costos totales y flujo neto anual de MuseIQ. Fuente: elaboración propia con base en la Tabla~\ref{tab:flujo-economico}.}
...
\begin{table}[h!]
	...
	\begin{tabular}{l c}
		...
		\hline
	\end{tabular}
	\caption{Indicadores económicos y financieros de MuseIQ en el escenario base. Fuente: elaboración propia.}
...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{7.6cm} c c}
		...
		\hline
	\end{tabular}
	\caption{Análisis de sensibilidad de MuseIQ respecto del escenario base. Fuente: elaboración propia.}
...
\begin{figure}[h!]
	...
	\caption{Comparación del valor actual neto de MuseIQ bajo escenarios de sensibilidad. Fuente: elaboración propia con base en la Tabla~\ref{tab:sensibilidad-financiera}.}
