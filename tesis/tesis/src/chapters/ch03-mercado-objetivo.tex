...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{2.8cm} >{\raggedright\arraybackslash}p{2.8cm} >{\raggedright\arraybackslash}p{3.1cm} >{\raggedright\arraybackslash}p{3.4cm} >{\raggedright\arraybackslash}p{2.1cm}}
		...
		\hline
	\end{tabular}
	\caption[Segmentación del mercado objetivo de MuseIQ]{Segmentación del mercado objetivo para MuseIQ. Fuente: elaboración propia con base en~\cite{museoscultura,osiptel2024smartphone,cultura2024reporte}.}
\end{table}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\textwidth]{segmentos_mercado_objetivo_prioridad.png}
	\caption[Prioridad de los segmentos del mercado objetivo]{Prioridad relativa de los segmentos del mercado objetivo de MuseIQ. Fuente: elaboración propia con base en la segmentación del capítulo.}
	\label{fig:segmentos-mercado-objetivo-prioridad}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.84\textwidth]{mapa_segmentacion_mercado_objetivo.png}
	\caption[Mapa de segmentación del mercado objetivo]{Mapa conceptual de segmentación del mercado objetivo de MuseIQ. Fuente: elaboración propia.}
	\label{fig:mapa-segmentacion-mercado-objetivo}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{criterios_mercado_objetivo_prioritario.png}
	\caption[Criterios para elegir el mercado objetivo prioritario]{Criterios comparativos para la elección del mercado objetivo prioritario. Fuente: elaboración propia.}
	\label{fig:criterios-mercado-objetivo-prioritario}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.88\textwidth]{ecosistema_nacional_adopcion_museiq.png}
	\caption[Ecosistema nacional de adopción de MuseIQ]{Ecosistema nacional de adopción de MuseIQ en el contexto peruano. Fuente: elaboración propia.}
	\label{fig:ecosistema-nacional-adopcion-museiq}
\end{figure}
