...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{brecha_demanda_mediacion_digital.png}
	\caption[Brecha entre demanda y mediación digital en museos]{Brecha entre la demanda cultural actual y la mediación digital disponible en museos. Fuente: elaboración propia.}
	\label{fig:brecha-demanda-mediacion-digital}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{ecosistema_museos_inteligentes.png}
	\caption[Ecosistema actual de museos inteligentes]{Componentes principales del ecosistema actual de museos inteligentes. Fuente: elaboración propia con base en la literatura y referentes revisados.}
	\label{fig:ecosistema-museos-inteligentes}
\end{figure}
...
Con base en los referentes analizados, la validación de la solución propuesta debe considerar simultáneamente desempeño técnico y experiencia de usuario. Se recomienda evaluar al menos: error medio de localización en metros, porcentaje de identificación correcta de sala, error angular de orientación, latencia de respuesta del sistema y métricas de usabilidad percibida. Este enfoque permite contrastar factibilidad técnica con valor de uso real en contexto museístico.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.94\textwidth]{ruta_metodologica_validacion_museiq.png}
	\caption[Ruta metodológica de validación de la solución propuesta]{Ruta metodológica sugerida para la validación de la solución propuesta en contexto museístico. Fuente: elaboración propia.}
	\label{fig:ruta-metodologica-validacion-museiq}
\end{figure}
...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{4.0cm} >{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{3.8cm}}
		\hline
		\textbf{Segmento / Fuente} & \textbf{Valor base} & \textbf{Proyecci\'on} & \textbf{Implicancia para la solución propuesta} \\
		\hline
		...
		\hline
	\end{tabular}
	\caption[Panorama global de mercado en tecnologías museales digitales]{Panorama global de mercado en tecnolog\'ias para experiencias museales digitales \textbf{Fuente:}~\cite{htf2025digital,grandview2024art,grandview2024hardware,grandview2024software,grandview2024services}}
\end{table}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.84\textwidth]{panorama_global_submercados_2024.png}
	\caption[Submercados museales digitales en 2024]{Comparación referencial de submercados museales digitales en 2024. Fuente: elaboración propia con base en~\cite{htf2025digital,grandview2024art,grandview2024hardware,grandview2024software,grandview2024services}.}
	\label{fig:panorama-global-submercados-2024}
\end{figure}
