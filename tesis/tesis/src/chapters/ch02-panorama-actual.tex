...
\begin{figure}[h!]
	...
	\caption{Brecha entre la demanda cultural actual y la mediación digital disponible en museos. Fuente: elaboración propia.}
...
\begin{figure}[h!]
	...
	\caption{Componentes principales del ecosistema actual de museos inteligentes. Fuente: elaboración propia con base en la literatura y referentes revisados.}
...
\begin{figure}[h!]
	...
	\caption{Ruta metodológica sugerida para la validación de MuseIQ en contexto museístico. Fuente: elaboración propia.}
...
\begin{figure}[h!]
	...
	\caption{Comparación referencial de submercados museales digitales en 2024. Fuente: elaboración propia con base en~\cite{htf2025digital,grandview2024art,grandview2024hardware,grandview2024software,grandview2024services}.}
