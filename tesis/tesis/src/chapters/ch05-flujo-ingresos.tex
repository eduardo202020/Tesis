...
\begin{figure}[h!]
	...
	\caption[Estructura referencial de ingresos por rubro]{Estructura referencial de ingresos por rubro en MuseIQ. Fuente: elaboración propia con base en los supuestos del escenario base.}
...
\begin{table}[h!]
	...
	\begin{tabular}{c c c c c c c}
		...
		\hline
	\end{tabular}
	\caption[Flujo de ingresos de MuseIQ en el escenario base]{Proyección referencial del flujo de ingresos de MuseIQ en el escenario base. Montos en USD. Fuente: elaboración propia con base en los supuestos del modelo.}
...
\begin{figure}[h!]
	...
	\caption[Evolución del ingreso total anual de MuseIQ]{Evolución del ingreso total anual de MuseIQ en el escenario base. Fuente: elaboración propia con base en la Tabla~\ref{tab:flujo-ingresos-base}.}
...
\begin{figure}[h!]
	...
	\caption[Crecimiento de instituciones activas de MuseIQ]{Crecimiento de la base de instituciones activas de MuseIQ en el escenario base. Fuente: elaboración propia con base en la Tabla~\ref{tab:flujo-ingresos-base}.}
...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{3.1cm} c c c}
		...
		\hline
	\end{tabular}
	\caption[Escenarios de proyección de ingresos de MuseIQ]{Escenarios de proyección del flujo de ingresos de MuseIQ. Fuente: elaboración propia.}
...
\begin{figure}[h!]
	...
	\caption[Comparación de escenarios de ingresos proyectados]{Comparación referencial de escenarios de ingresos proyectados para MuseIQ. Fuente: elaboración propia con base en los supuestos de la Tabla~\ref{tab:escenarios-ingresos}.}
