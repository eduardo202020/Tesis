...
\begin{figure}[h!]
	...
	\caption[Mapa conceptual del problema central de MuseIQ]{Mapa conceptual del problema central abordado por MuseIQ. Fuente: elaboración propia.}
...
\begin{figure}[h!]
	...
	\caption[Arquitectura conceptual general de MuseIQ]{Arquitectura conceptual general de la solución MuseIQ. Fuente: elaboración propia.}
...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{4.3cm} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{3.6cm} >{\raggedright\arraybackslash}p{3.6cm}}
		...
		\hline
	\end{tabular}
	\caption[Trabajos y referentes clave para MuseIQ]{Trabajos y referentes clave para el desarrollo de MuseIQ \textbf{Fuente:}~\cite{verde2023blemuseum,wang2024voiceguide,ivanov2025smartmuseums,bloomberg2025connects}}
\end{table}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.92\textwidth]{relacion_problema_solucion_aporte.png}
	\caption[Relación entre problema, solución y aporte de MuseIQ]{Relación entre el problema identificado, la respuesta tecnológica de MuseIQ y el aporte esperado. Fuente: elaboración propia.}
