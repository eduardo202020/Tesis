...
\begin{table}[h!]
	...
	\begin{tabular}{l c c}
		...
		\hline
	\end{tabular}
	\caption[Evolución de hogares peruanos con smartphone]{Evolución de hogares peruanos con smartphone \textbf{Fuente:}~\cite{osiptel2021smartphone,osiptel2022smartphone,osiptel2023smartphone,osiptel2024smartphone}}
	\label{tab:smartphones-peru-2019-2024}
\end{table}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\textwidth]{smartphones_peru_2019_2024.png}
	\caption[Evolución de hogares peruanos con smartphone (2019--2024)]{Evolución de hogares peruanos con smartphone entre 2019 y 2024. Fuente: elaboración propia con base en~\cite{osiptel2021smartphone,osiptel2022smartphone,osiptel2023smartphone,osiptel2024smartphone}.}
	\label{fig:smartphones-peru-2019-2024}
\end{figure}
...
\begin{table}[h!]
	...
	\begin{tabular}{l c l}
		...
		\hline
	\end{tabular}
	\caption[Evolución de visitas a museos del Ministerio de Cultura]{Evolución de visitas a museos administrados por el Ministerio de Cultura \textbf{Fuente:}~\cite{culturapesem2021,cultura2020memoria,cultura2022memoria,cultura2023memoria,cultura2024reporte}}
	\label{tab:visitas-museos-peru-2019-2024}
\end{table}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.82\textwidth]{visitas_museos_peru_2019_2024.png}
	\caption[Evolución de visitas a museos del Estado (2019--2024)]{Evolución de visitas a museos administrados por el Estado entre 2019 y 2024. Fuente: elaboración propia con base en~\cite{culturapesem2021,cultura2020memoria,cultura2022memoria,cultura2023memoria,cultura2024reporte}.}
	\label{fig:visitas-museos-peru-2019-2024}
\end{figure}

En el plano internacional, UNESCO plantea que las tecnologías digitales están redefiniendo las condiciones de acceso, experiencia y preservación de bienes culturales, y enfatiza su potencial para reducir desigualdades y promover innovación sectorial~\cite{unesco2025globalreport}. Esta evidencia respalda la pertinencia de la solución propuesta como respuesta aplicada a una transformación estructural de la gestión cultural contemporánea.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{mapa_problema_central_museiq.png}
	\caption[Mapa conceptual del problema central de la solución propuesta]{Mapa conceptual del problema central abordado por la solución propuesta. Fuente: elaboración propia.}
	\label{fig:mapa-problema-central-museiq}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.92\textwidth]{arquitectura_conceptual_museiq.png}
	\caption[Arquitectura conceptual general de la solución propuesta]{Arquitectura conceptual general de la solución propuesta. Fuente: elaboración propia.}
	\label{fig:arquitectura-conceptual-museiq}
\end{figure}
...
\begin{table}[h!]
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{4.3cm} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{3.6cm} >{\raggedright\arraybackslash}p{3.6cm}}
		\hline
		\textbf{Referente} & \textbf{Tipo} & \textbf{Aporte principal} & \textbf{Relevancia para la solución propuesta} \\
		\hline
		...
		\hline
	\end{tabular}
	\caption[Trabajos y referentes clave para la solución propuesta]{Trabajos y referentes clave para el desarrollo de la solución propuesta \textbf{Fuente:}~\cite{verde2023blemuseum,wang2024voiceguide,ivanov2025smartmuseums,bloomberg2025connects}}
\end{table}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.92\textwidth]{relacion_problema_solucion_aporte.png}
	\caption[Relación entre problema, solución y aporte de la solución propuesta]{Relación entre el problema identificado, la respuesta tecnológica de la solución propuesta y el aporte esperado. Fuente: elaboración propia.}
	\label{fig:relacion-problema-solucion-aporte}
\end{figure}
